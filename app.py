    ...
    def run_monte_carlo(self, n_simulations=5000):
        ...
        for i in range(n_simulations):
            ...
            for t, age in enumerate(years):
                ...
                # F. 자산 변동 (가장 중요한 부분)
                # 수입이 지출보다 크면 net_withdrawal이 마이너스(-)가 되어 자산에 플러스(+)로 저축됨!
...
def main():
    st.set_page_config(layout="wide", page_title="Financial Asset Sim V27.1")
    
    st.title("💰 고정밀 금융자산 시뮬레이터 V27.1 (The Final)")
